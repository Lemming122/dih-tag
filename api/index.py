...
class GameInfo:
    def __init__(self):
        self.TitleId: str = "6A58D"  # Playfab Title Id
        self.SecretKey: str = "KDQTOZUZPX57SCHPY1F69BKMKBSHTWMBRZZ7NDGW6DN6BKC9FJ"  # Playfab Secret Key
        self.ApiKey: str = "OC|1058290767378027|6226fbdae65cccb323e9896b22b603f2"  # App Api Key (Oculus/Graph API)
